...
Supabase:
type text not null default 'STANDARD'::text,
status text not null default 'DRAFT'::text,
minimum_bids numeric null default '10'::numeric,
bid_currency text null,
allowed_free_bids array null,
over_bid_good_time_active boolean null default true,
over_bid_good_time_early_fee numeric null default '0'::numeric,
over_bid_good_time_often_fee numeric null default '0'::numeric,
over_bid_good_time_late_fee numeric null default '250'::numeric,
*/
...
export const AuctionAdminPage = () => {
  ...
  // form state
  const [ updatesResult, setUpdateResult ] = useState<PostgrestSingleResponse<null>>();
      ...
      <div className="flex flex-row w-full border-t">
        <div className="flex items-center flex-grow pl-4">
          <p className="text-sm text-neutral-300">
            { ( updatesResult === undefined ) ? "form status/errors info here" : updatesResult.status }
          </p>
        </div>
        <div className="p-4">
          <button
