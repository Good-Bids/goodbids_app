    ...
    <div className="flex h-full w-full flex-col">
      ...
      >
        ...
        <div
          ...
          className="flex h-[72px] w-full flex-row items-start justify-between self-start border-t-[1px] border-outerSpace-100 bg-white px-2 py-2 sm:h-fit sm:w-full sm:px-4 sm:py-2"
        >
          <Link
