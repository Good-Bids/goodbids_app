...
import { I_CreateCharityFormValues } from "~/utils/types/charities";
...
const createCharity = async (data: I_CreateCharityFormValues) => {
...
export const useCreateCharity = (data: I_CreateCharityFormValues) => {
